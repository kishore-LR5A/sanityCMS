...
function Post({ post }: Props) {
  ...
  return (
    <main>
      ...
      {submitted ? (
        <div className="flex flex-col py-10 my-10 text-white bg-yellow-500 max-w-2xl mx-auto">
        ...
        >
          ...
          {/* errors will be shown when validation is failed. */}
          ...
          <input
            type="submit"
            className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-while font-bold py-2 px-4 rounded cursor-pointer"
          />
        </form>
      )}
